...
0% {opacity: 0.8; transform: translateX(-2px) skewY(3deg) skewX(2deg) rotateZ(1deg); filter: blur(0px);}
...
100% {opacity: 0.8; transform: translateX(-2px) skewY(3deg) skewX(2deg) rotateZ(1deg); filter: blur(0px);}`;
